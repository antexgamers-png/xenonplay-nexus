...
/**
 * XENONPLAY CINEMATIC WELCOME SIGNAGE
 * Ultra-Premium UI/UX Design by App Prototyper.
 * Dioptimalkan untuk performa browser Smart TV (Zero-Lag Animation).
 */
...
export default function WelcomePage() {
    ...
    return (
        <div className="fixed inset-0 h-screen w-screen bg-[#02040a] text-white overflow-hidden font-body flex flex-col border-none select-none">
            ...
            {/* AMBIENT BACKGROUND LAYER (Optimized Gradients) */}
            ...
            <header className="h-[14vh] flex justify-between items-center px-[6vw] z-20 relative shrink-0">
                <div className="flex items-center gap-[2.5vw]">
                    <motion.div 
                        ...
                        className="relative h-[9vh] w-[9vh] drop-shadow-[0_0_25px_rgba(59,130,246,0.5)]"
                    >
