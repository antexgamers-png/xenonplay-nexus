...
export function WifiPos({ packages }: { packages: PricingRule[] }) {
    ...
    const handleSell = async () => {
        ...
        try {
            ...
            setLastOrder({ ...transaction, pkgName: pkg.name, duration: pkg.duration });
    ...
    const handlePrintVoucher = () => {
        ...
        const formattedDuration = formatDuration(lastOrder.duration);
        ...
        <body>
            <div id="receipt-target" class="receipt-paper">
                ...
                <div class="center py-6">
                    ...
                    <div style="font-size: 3.2em; font-weight: 900; margin: 10px 0; letter-spacing: 4px; line-height: 1; white-space: nowrap;">${lastOrder.claimCode}</div>
                    <div class="bold" style="font-size: 1.2em; text-transform: uppercase; margin-top: 5px; color: #3b82f6; letter-spacing: 1px;">DURASI: ${formattedDuration}</div>
                    <div style="font-size: 0.8em; text-transform: uppercase; margin-top: 4px; opacity: 0.5;">PAKET: ${lastOrder.pkgName}</div>
                </div>
                <div class="sep"></div>
